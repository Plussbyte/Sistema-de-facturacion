    ...
    export function utilityButtonCircle(){ // <---- Contiene la logica del boton circulo 
        ...
        //Controla el hover del boton circulo
            ...
            buttonCircle.addEventListener('mouseover',()=>{
                ...
                buttonCircle.style.border = '2px #e42820 solid'
                document.getElementById('textCircle').style.color = '#e42820'
                document.getElementById('arrowCircle').src = './images/flecha curva roja.png'
                document.getElementById('arrowCircle2').src = './images/flecha curva roja.png'
            })
            buttonCircle.addEventListener('mouseout',()=>{
                buttonCircle.style.backgroundColor = '#e42820'
                buttonCircle.style.border = 'none'
                document.getElementById('textCircle').style.color = 'white'
